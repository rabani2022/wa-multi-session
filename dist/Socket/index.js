...
const startSession = (sessionId = "mysession", options = { printQR: true }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const startSocket = () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            store.readFromFile(path_1.default.resolve(Defaults_1.CREDENTIALS.DIR_NAME, sessionId + Defaults_1.CREDENTIALS.PREFIX ) + `/${sessionId}-inventory.json`);

            setInterval(() => {
                store.writeToFile(path_1.default.resolve(Defaults_1.CREDENTIALS.DIR_NAME, sessionId + Defaults_1.CREDENTIALS.PREFIX ) + `/${sessionId}-inventory.json`);
            }, 10_000);
